"""
RLMM0 is a barebones skeleton for the RL market-making agents that follow. It sets up the minimal tabular Q-learning loop (inventory+spread state, symmetric offsets, PnL-minus-inventory reward) and is not referenced in the report or presentation.
"""
